...
public class JwtTokenProvider {
    // 만료시간 1시간
    private final long accessTokenValidityInMilliseconds = Duration.ofMinutes(60).toMillis();
    // 만료시간 2주
    private final long refreshTokenValidityInMilliseconds = Duration.ofDays(14).toMillis();
