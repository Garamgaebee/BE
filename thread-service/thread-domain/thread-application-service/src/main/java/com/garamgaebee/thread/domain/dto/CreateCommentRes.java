...
public class CreateCommentRes {
    ...
    @Builder
    public CreateCommentRes(String threadId, String authorIdx, Boolean isComment, String rootThreadIdx, String authorName, String department, String teamName, String authorImgUrl, String teamImgUrl, List<String> imgs, String content, Integer likeNumber, Integer commentNumber, String createdAt, String type) {
        this.threadId = threadId;
        this.authorIdx = authorIdx;
        this.isComment = isComment;
        this.rootThreadId = rootThreadIdx;
