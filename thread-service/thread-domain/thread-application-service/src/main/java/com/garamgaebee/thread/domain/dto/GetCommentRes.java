...
public class GetCommentRes {
    ...
    @Schema(name = "commentId", description = "댓글 인덱스(댓글과 스레드는 같은 테이블에서 관리)", example = "UUID String")
    private String commentId;
    @Schema(name = "rootThreadId", description = "댓글이 속한 게시글(스레드) 인덱스, 댓글일 경우 NONE으로 리턴", example = "NONE")
    ...
    @Builder
    public GetCommentRes(String authorIdx, String commentId, String rootThreadId, String authorImgUrl, String teamImgUrl, String authorName, String department, String teamName, List<String> imgs, String content, int likeNumber, String createdAt, Boolean isComment, String type) {
